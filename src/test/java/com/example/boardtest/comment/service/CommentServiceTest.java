...
public class CommentServiceTest {
    ...
    void commentFindAll() {
        ...
        Page<CommentResponse> result = commentService.commentFindAll(board.getId(), pageable);
    ...
    void commentDeleteFail() {
        ...
        verify(commentRepository, never()).delete(comment); // 댓글 삭제가 호출되지 않았는지 검증
    }
